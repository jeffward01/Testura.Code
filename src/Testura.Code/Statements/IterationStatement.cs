...
public class IterationStatement
{
    ...
    public ForStatementSyntax For(
        int start, int end, string variableName,
        BlockSyntax body)
    {
    ...
    /// <returns>The declared for statement syntax.</returns>
    public ForStatementSyntax For(
        VariableReference start, VariableReference end, string variableName,
        BlockSyntax body)
    {
        if (start == null)
        {
    ...
    public ForEachStatementSyntax ForEach(
        string variableName, Type variableType, string enumerableName,
        BlockSyntax body, bool useVar = true)
    {
        return ForEach(
            variableName,
            variableType,
            new VariableReference(enumerableName),
            body,
            useVar);
    }
    ...
    /// <returns>The declared foreach statement syntax.</returns>
    public ForEachStatementSyntax ForEach(
        string variableName, Type variableType, VariableReference enumerableReference,
        BlockSyntax body, bool useVar = true)
    {
        if (string.IsNullOrEmpty(variableName))
        {
