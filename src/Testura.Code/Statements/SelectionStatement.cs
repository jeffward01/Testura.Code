...
public class SelectionStatement
{
    ...
    public StatementSyntax If(
        IArgument leftArgument, IArgument rightArgument, ConditionalStatements conditional,
        BlockSyntax block)
    {
        ...
        return IfStatement(
            BinaryExpression(
                ...
                leftArgument.GetArgumentSyntax()
                    .Expression,
                rightArgument.GetArgumentSyntax()
                    .Expression),
            block);
    }
    ...
    /// <returns>The declared statement syntax.</returns>
    public StatementSyntax If(
        IBinaryExpression binaryExpression, ExpressionStatementSyntax expressionStatement)
    {
        if (binaryExpression == null)
        {
            throw new ArgumentNullException(nameof(binaryExpression));
