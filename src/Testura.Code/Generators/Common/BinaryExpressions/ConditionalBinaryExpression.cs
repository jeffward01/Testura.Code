...
/// <summary>
///     Provides the functionality to generate a conditional binary expression. Example of generated
///     code: <c>test()+test.MyProp</c>
/// </summary>
public class ConditionalBinaryExpression : IBinaryExpression
{
    ...
    public ExpressionSyntax GetBinaryExpression()
    {
        return SyntaxFactory.BinaryExpression(
            ConditionalFactory.GetSyntaxKind(_conditional),
            _leftExpression,
            _rightExpression);
    }
}
