...
/// <summary>
///     Provides the functionality to generate lambda arguments. Example of generated code:
///     <c>(n=>MyMethod())</c>
/// </summary>
public class LambdaArgument : Argument
{
    ...
    public LambdaArgument(
        ExpressionSyntax expressionSyntax, string parameterName, string namedArgument = null)
        : base(namedArgument)
    {
    ...
    /// <param name="namedArgument">Specify the argument for a particular parameter.</param>
    public LambdaArgument(
        BlockSyntax blockSyntax, string parameterName, string namedArgument = null)
        : base(namedArgument)
    {
    ...
    protected override ArgumentSyntax CreateArgumentSyntax()
    {
        ...
        if (_blockSyntax != null)
        {
            expression = SimpleLambdaExpression(
                Parameter(Identifier(_parameterName)),
                _blockSyntax);
        }
        else
        {
