...
/// <summary>
///     Provides the functionality to generate creation of an objection using it's constructor. Example
///     of generated code: <c>(new MyClass())</c>
/// </summary>
public class ObjectCreationArgument : Argument
{
    ...
    public ObjectCreationArgument(
        Type type, IEnumerable<IArgument>? arguments = null, IEnumerable<Type>? genericTypes = null,
    ...
    protected override ArgumentSyntax CreateArgumentSyntax()
    {
        return SyntaxFactory.Argument(
            ObjectCreationGenerator.Create(_type, _arguments, _genericTypes));
    }
}
