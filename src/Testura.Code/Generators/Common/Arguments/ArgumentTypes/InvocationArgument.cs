...
/// <summary>
///     Provides the functionality to generate invocation arguments. Example of generated code:
///     <c>(Do())</c>
/// </summary>
public class InvocationArgument : Argument
{
    ...
    public InvocationArgument(
        ExpressionSyntax invocation, Type? castTo = null, string namedArgument = null)
        : base(namedArgument)
    {
    ...
    /// <param name="namedArgument">Specify the argument for a particular parameter.</param>
    public InvocationArgument(
        VariableReference reference, Type castTo = null, string namedArgument = null)
        : base(namedArgument)
    {
        if (reference == null)
        {
        ...
        _invocation = Statement.Expression.Invoke(reference)
            .AsExpression();
        _castTo = castTo ?? typeof(void);
    }
    ...
    protected override ArgumentSyntax CreateArgumentSyntax()
    {
        if (_castTo != typeof(void))
        {
            return SyntaxFactory.Argument(
                SyntaxFactory.CastExpression(TypeGenerator.Create(_castTo), _invocation));
        }
