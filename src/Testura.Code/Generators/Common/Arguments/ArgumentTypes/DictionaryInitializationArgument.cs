...
/// <summary>
///     Provides the functionality to generate dictionary initialization argument. Example of generated
///     code: <c>new Dictionary&lt;int,int>{ [1] = 2}</c>
/// </summary>
    ...
    where TKey : notnull
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="DictionaryInitializationArgument{TKey, TValue}" />
    ///     class.
    /// </summary>
    ...
    public DictionaryInitializationArgument(
        IDictionary<TKey, IArgument> dictionary, string namedArgument = null)
        : base(namedArgument)
    {
        ...
        foreach (var dictionaryValue in _dictionary)
        {
            syntaxNodeOrTokens.Add(
                AssignmentExpression(
                    ...
                    dictionaryValue.Value.GetArgumentSyntax()
                        .Expression));
