...
#pragma warning restore SA1201
    ...
    [Test]
    public void
        Assign_WhenAssignVariableReferenceThatIsAMethodToVariableReference_ShouldThrowException()
    {
        Assert.Throws<ArgumentException>(
            () => _statement.Assign(
                new VariableReference("test", new MethodReference("Test")),
                new VariableReference("test", new MethodReference("Do"))));
    }
    ...
    public void Assign_WhenAssignVariableReferenceToBinaryExpression_ShouldAssignVariable()
    {
        Assert.AreEqual(
            "test.Test=1+2;",
            _statement.Assign(
                    new VariableReference("test", new MemberReference("Test")),
    ...
    public void Assign_WhenAssignVariableReferenceToVariableReference_ShouldAssignVariable()
    {
        Assert.AreEqual(
            ...
            _statement.Assign(
                    new VariableReference("test", new MemberReference("Test")),
                    new VariableReference("test", new MemberReference("Do")))
                .ToString());
    }
    ...
    public void Assign_WhenAssignVariableToClassInstance_ShouldAssignVariable()
    {
        Assert.AreEqual(
            "test=newList();",
            _statement.Assign("test", typeof(List), ArgumentGenerator.Create())
                .ToString());
    }
    ...
    public void Assign_WhenAssignVariableToExpression_ShouldAssignVariable()
    {
        Assert.AreEqual(
            ...
            _statement.Assign(
                    "test",
                    new ExpressionStatement().Invoke("MyMethod")
                        .AsExpression())
                .ToString());
    }
    ...
    public void Assign_WhenAssignVariableToReference_ShouldAssignVariable()
    {
        Assert.AreEqual(
            "test=myVariable;",
            _statement.Assign("test", new VariableReference("myVariable"))
                .ToString());
    }
    ...
    {
        Assert.AreEqual(
            "vartestVariable=\"hello\";",
            _statement.DeclareAndAssign("testVariable", "hello")
                .ToString());
    }

    [Test]
    public void
        DeclareAndAssign_WhenCreateTypeAndAssignToBinaryExpression_ShouldAssignToExpressionAndCast()
    {
        Assert.AreEqual(
            "vartest=1+2;",
            _statement.DeclareAndAssign(
                    "test",
                    typeof(int),
                    new MathBinaryExpression(
                        new ConstantReference(1),
    ...
    [Test]
    public void
        DeclareAndAssign_WhenCreateTypeAndAssignToClassInstance_ShouldAssignToClassInstance()
    {
        Assert.AreEqual(
            "vartest=newList();",
            _statement.DeclareAndAssign("test", typeof(List), ArgumentGenerator.Create())
                .ToString());
    }
    ...
    public void DeclareAndAssign_WhenCreateTypeAndAssignToContant_ShouldAssignToVarible()
    {
        Assert.AreEqual(
            "vartest=1;",
            _statement.DeclareAndAssign("test", typeof(int), new ConstantReference(1))
                .ToString());
    }
    ...
    [Test]
    public void
        DeclareAndAssign_WhenCreateTypeAndAssignToExpressionAndCast_ShouldAssignToExpressionAndCast()
    {
        Assert.AreEqual(
            "vartest=(int)MyMethod();",
            _statement.DeclareAndAssign(
                    "test",
                    typeof(int),
                    new ExpressionStatement().Invoke("MyMethod")
    ...
    [Test]
    public void
        DeclareAndAssign_WhenCreateTypeAndAssignToExpressionAndNotUsingVarKeyword_ShouldAssignToExpressionWithoutVarKeyword()
    {
        Assert.AreEqual(
            "inttest=MyMethod();",
            _statement.DeclareAndAssign(
    ...
    public void DeclareAndAssign_WhenCreateTypeAndAssignToStringPathConstant_ShouldAssignToVarible()
    {
        Assert.AreEqual(
            ...
            _statement.DeclareAndAssign(
                    "test",
                    typeof(int),
                    new ConstantReference("1", StringType.Path))
                .ToString());
    }
    ...
    public void DeclareAndAssign_WhenCreateTypeAndAssignToVariableMember_ShouldAssignToVarible()
    {
        Assert.AreEqual(
            ...
            _statement.DeclareAndAssign(
                    "test",
                    typeof(int),
                    new VariableReference("var", new MemberReference("member")))
                .ToString());
    }
    ...
    public void DeclareAndAssign_WhenCreateTypeAndAssignToVariableReference_ShouldAssignToVarible()
    {
        Assert.AreEqual(
            "vartest=myVariable;",
            _statement.DeclareAndAssign("test", typeof(int), new VariableReference("myVariable"))
                .ToString());
    }
    ...
    public void DeclareAndAssign_WhenCreatingVariableWithoutVar_ShouldUseType()
    {
        Assert.AreEqual(
            "inttestVariable=1;",
            _statement.DeclareAndAssign("testVariable", 1, false)
                .ToString());
    }
    ...
    public void DeclareAndAssign_WhenCreatingVariableWithVar_ShouldUseVar()
    {
        Assert.AreEqual(
            "vartestVariable=1;",
            _statement.DeclareAndAssign("testVariable", 1)
                .ToString());
    }
}
