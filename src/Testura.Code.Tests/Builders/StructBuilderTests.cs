...
#pragma warning restore SA1201
    ...
    {
        Assert.IsTrue(
            _structBuilder.WithAttributes(new Attribute("MyAttribute"))
                .Build()
                .ToString()
    ...
    {
        Assert.IsTrue(
            _structBuilder.ThatInheritFrom(typeof(int))
                .Build()
                .ToString()
                .Contains("TestStruct:int"));
    }
    ...
    {
        Assert.IsTrue(
            _structBuilder.WithModifiers(Modifiers.Public, Modifiers.Abstract)
                .Build()
                .ToString()
                .Contains("publicabstractstructTestStruct"));
    }
    ...
    {
        Assert.IsTrue(
            _structBuilder.WithUsings("some.namespace")
                .Build()
                .ToString()
