...
public class AssignArgumentTests
{
    ...
    public void GetArgumentSyntax_WhenUsingAssignArgumentWithObject_ShouldGetCode(
    ...
    {
        var argument = new AssignArgument(
            "hello",
            ReferenceGenerator.Create(
                new VariableReference("myVariable", new MemberReference("hello"))));
        var syntax = argument.GetArgumentSyntax();
