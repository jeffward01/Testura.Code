...
public class MathBinaryExpressionTests
{
    ...
    {
        var binaryExpression = new MathBinaryExpression(
    ...
    {
        var rightBinaryExpression = new MathBinaryExpression(
            new ConstantReference(3),
            new ConstantReference(5),
            MathOperators.Add);
        var binaryExpression = new MathBinaryExpression(
            new ConstantReference(1),
    ...
    [Test]
    public void
        GetBinaryExpression_WhenUsingMultipleMathBinaryExpressionAndUsingParentheses_ShouldGenerateCode()
    {
        var rightBinaryExpression = new MathBinaryExpression(
            new ConstantReference(3),
            new ConstantReference(5),
